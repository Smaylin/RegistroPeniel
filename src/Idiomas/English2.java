...
public class English2 extends javax.swing.JFrame {
...
//        combo = ComboBoxBuscar.getItemAt(ComboBoxBuscar.getSelectedIndex()).getCodigo();
    ...
    private void initComponents() {
        ...
        btNombre1.setText("Buscar por Nombre");
        btNombre1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btNombre1ActionPerformed(evt);
            }
        });

        btID1.setText("Buscar por ID");
        btID1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btID1ActionPerformed(evt);
            }
        });
        ...
        jDesktopPane2.setLayer(btActualizar1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jDesktopPane2.setLayer(btNombre1, javax.swing.JLayeredPane.DEFAULT_LAYER);
        jDesktopPane2.setLayer(btID1, javax.swing.JLayeredPane.DEFAULT_LAYER);
                    ...
                    .addGroup(jDesktopPane2Layout.createSequentialGroup()
                        .addGroup(jDesktopPane2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jDesktopPane2Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addGroup(jDesktopPane2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btID1, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btNombre1, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addContainerGap())
        );
    ...
    private void btNombre1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNombre1ActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_btNombre1ActionPerformed

    private void btID1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btID1ActionPerformed
        // TODO add your handling code here:
        String nombre =this.txtID.getText().toString();
        //        String nombre = (String) this.ComboBoxBuscar.getSelectedItem().toString();
        ConexionConsultas cn = new ConexionConsultas();
    ...
    }//GEN-LAST:event_btID1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(English2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btID1;
